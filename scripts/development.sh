...
# Rewriting provision-moody.sh
# This bash script is required to execute the needed actions
#   - for spinning up the current Moody College Tasks tool.
# This particular revision of the script is to generate the files
#   - or re-generate the files on a local development site for Git
#   - version control and Installation management.
