...
git clone https://comm-webmaster@bitbucket.org/moodycollegedevelopers/moody-redesign.git /var/tmp/utdrupalkit
git clone https://comm-webmaster@bitbucket.org/moodycollegedevelopers/migration_theme.git /var/tmp/utdrupalkit/sites
echo "... done."
echo "====="
echo "-- Adding clean .htaccess file to respository"
cp -rp /var/www/redesign/settings-files/d7-default/.htaccess /var/tmp/utdrupalkit/.htaccess
...
do
  ...
  cp -p /var/www/redesign/settings-files/d7-default/settings.php /var/www/public_html/d7/${default_settings}/sites/default/settings.php
  cp -p /var/www/redesign/settings-files/d7-default/default.settings.php /var/www/public_html/d7/${default_settings}/sites/default/
done
...
do
  ...
  cp -p /var/www/redesign/settings-files/d7/${configuring_redesign}/local-settings.php /var/www/public_html/d7/${configuring_redesign}/sites/default/
  cp -p /var/www/redesign/settings-files/d7-default/.htaccess /var/www/public_html/d7/${configuring_redesign}/sites/default/
  cp -p /var/www/redesign/settings-files/d7-default/.htaccess /var/www/public_html/d7/${configuring_redesign}/
  echo "...done."
  echo "==========================================================================="
done
